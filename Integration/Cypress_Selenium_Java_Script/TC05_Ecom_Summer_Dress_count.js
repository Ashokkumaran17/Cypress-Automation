describe("My first testsuite",function ()
{
    ...
    it("Click Dress category and display the Summer Dress count",function (){
        ...
        cy.wait(4000)
        //click Casual dress
        cy.get('li.last').contains('Summer Dresses').click()
        //cy.get('div#categories_block_left>ul>li').eq(3).should('have.text','Summer Dresses').click()
        //count the no of items on casual Dresses
        cy.wait(2000)
        cy.get('#center_column > ul > li').should('have.length',3)
